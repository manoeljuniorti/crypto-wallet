...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference("Description.count") do
      post descriptions_url, params: { description: { acronym: @description.acronym, url_image: @description.url_image } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { acronym: @description.acronym, url_image: @description.url_image } }
